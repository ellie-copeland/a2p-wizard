          ...
          {STEPS.map((step, i) => (
            <button
              ...
              className={`flex-1 text-center py-1.5 rounded-[4px] text-[10px] font-medium uppercase tracking-wide transition-colors
                ${i === currentStep ? "border border-[#020617] text-[#020617] bg-white" : i < currentStep ? "border border-[#10A37F]/20 bg-[#10A37F]/5 text-[#10A37F] hover:bg-[#10A37F]/10 cursor-pointer" : "text-[#7F7F7F] cursor-not-allowed"}`}
            >
              {step}
            </button>
          ))}
